    ...
    <div className="metrics-section">
      ...
      <div className="risk-section">
        ...
        <div className="risk-metrics">
          <div className="risk-item">
            ...
            <div className="risk-value">{currentData.Risks.ValueAtRisk}</div>
          </div>
          <div className="risk-item">
      ...
      <div className="recent-changes">
        ...
        <div className="changes-content">
          <div className="changes-label">{currentData.RecentChanges}</div>
          <div className="liquidity-section">
            <div className="liquidity-label">Liquidity</div>
            <div className="liquidity-value">{currentData.Liquidity} %</div>
          </div>
